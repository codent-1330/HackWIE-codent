...
class OutputGeneration:
    ...
    def read_blob_data(self):
        session['photo_path'] = "C:/Users/yaswanthi/Document/Github/HackWIE-codent/xray_images\\" + session['unique'] + ".jpeg"
    ...
    def calling_keras(self, path_of_retrieved_image):
        ...
        model = tensorflow.keras.models.load_model('C:/Users/yaswanthi/Document/Github/HackWIE-codent/keras_model.h5')
        # model.compile()
